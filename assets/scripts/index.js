    ...
    return {
        ...
        initChat: function () {
            ...
            var handleClick = function (e) {
                ...
                tpl += '<a href="#" class="name">Admin</a>&nbsp;';
                tpl += '<span class="datetime">di ' + time_str + '</span>';
                tpl += '<span class="body">';
                tpl += text;
                tpl += '</span>';
                tpl += '</div>';
        ...
        initDashboardDaterange: function () {
            ...
            $('#dashboard-report-range').daterangepicker({
                ...
                ranges: {
                    ...
                    'Bulan Terakhir': [moment().subtract('month', 1).startOf('month'), moment().subtract('month', 1).endOf('month')]
                },
                buttonClasses: ['btn'],
                applyClass: 'blue',
                cancelClass: 'default',
                ...
                locale: {
                    ...
                    fromLabel: 'Dari',
                    toLabel: 'Ke',
                    customRangeLabel: 'Kostum Rentang',
                    daysOfWeek: ['Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab', 'Mi'],
                    monthNames: ['Januari', 'Februari', 'Maret', 'April', 'Mai', 'Juni', 'Juli', 'Agustus', 'September', 'October', 'November', 'Desember'],
                    firstDay: 1
                }
            },
            function (start, end) {
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: 'Butuh persetujuan, rumah Cipta Mandiri blok. M no. 1 Marketing Michael',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    // (string | mandatory) the heading of the notification
                    title: 'Mohon Diingat untuk Moderator',
                    // (string | mandatory) the text inside the notification
                    text: 'Pesan ini terkirim dari marketing Michael, mohon untuk di baca',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    title: 'Notifikasi',
                    // (string | mandatory) the text inside the notification
                    text: 'Anda memiliki 3 pesan baru',
                    // (string | optional) the image to display on the left
